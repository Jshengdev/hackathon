...
const decks = [
  { href: "/round-1", k: "round 1", b: "5-min · 13 slides · ironsight-anchored" },
      ...
      <div className="max-w-3xl w-full flex flex-col gap-12">
        <div className="flex flex-col gap-6">
          ...
          <p className="sans text-base md:text-lg smoke max-w-xl">
            video → tribe v2 → k2 swarm → claude opus → iterative loop → empathy-layer document. one
            engine answers ironsight&apos;s spatial-intel brief and listen labs&apos;s simulate-humanity
            brief.
          </p>
        </div>
